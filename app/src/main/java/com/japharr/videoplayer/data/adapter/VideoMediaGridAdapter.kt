...
import kotlinx.android.synthetic.main.video_grid_item.view.*
import java.io.File
 ...
 */
class VideoMediaGridAdapter(var context: Context, var videoMedias: ArrayList<VideoMedia>, var action: VideoMediaClickListener): RecyclerView.Adapter<VideoMediaGridAdapter.ViewHolder>() {
    ...
    inner class ViewHolder(parent: ViewGroup): RecyclerView.ViewHolder(parent.inflate(R.layout.video_grid_item)) {
